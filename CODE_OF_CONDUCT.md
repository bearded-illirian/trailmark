...
discussions, external channels linked from the repo), and also applies when
an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the maintainers via the channel listed in [`SECURITY.md`](./SECURITY.md)
(the same private channel — for both security disclosures and conduct
