...
| **Стоимость типичной задачи** | Не применимо (человеческий труд) | Средняя (зависит от custom кода) | Низкая (single-turn промпты) | **Низкая ($0.15-2/блок)** vs $5-10 в agent-heavy фреймворках |
