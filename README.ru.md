...
![Одна задача во Flow UI — каждый артефакт цепочки скиллов первоклассный файл](docs/assets/flow-ui-task.png)

![Глобальная статистика — Trailmark на реальном production-экземпляре (18 тыс. артефактов, 5,5 тыс. деплоев, 6 доменов)](docs/assets/flow-ui-global.png)
...
![Разбивка задач во Flow UI — топ проектов, типы задач, распределение типов артефактов](docs/assets/flow-ui-tasks-breakdown.png)
...
![Вкладка Deploys во Flow UI — каждый коммит привязан к задаче + блоку + артефакту](docs/assets/flow-ui-deploys.png)
...
![Методология скиллов во Flow UI — какие скиллы активно используются, какие спят, покрытие по доменам](docs/assets/flow-ui-skills.png)
